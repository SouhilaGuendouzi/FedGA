...
def args_parser():
    ...
    parser.add_argument('--id', type=int, default=0, help="id of the cloud") 
    parser.add_argument('--epochs', type=int, default=3, help=" FL rounds") 
    ...
    parser.add_argument('--myport', type=int, default=11111, help="server port")
    parser.add_argument('--myadr', type=str, default='127.0.0.1', help="server port") 
